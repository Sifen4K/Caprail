...
- NSIS installer: `src-tauri/target/release/bundle/nsis/Caprail_0.1.2_x64-setup.exe`
...
- NSIS 安装包：`src-tauri/target/release/bundle/nsis/Caprail_0.1.2_x64-setup.exe`
